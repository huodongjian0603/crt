...
if __name__ == '__main__':
    ...
    parser.add_argument("--voc12_root", type=str, default="../../VOC2012",
    ...
    parser.add_argument("--cam_scales", default=(1.0, 0.5, 1.5, 2.0, 0.75, 1.25, 1.75),
    ...
    parser.add_argument("--cam1_weights_name", default="sess/res152_cam.pth", type=str)
    parser.add_argument("--cam2_weights_name", default="sess/deits_cam.pth", type=str)
